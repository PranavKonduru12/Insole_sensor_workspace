 ...
 * This sends text to the USB serial device directly instead of relying
 * on the default printk console routing.
 */
...
/*
 * Keep the original template mostly unchanged:
 * every printk(...) below now goes directly to the CDC ACM COM port.
 */
